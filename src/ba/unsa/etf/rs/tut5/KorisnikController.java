...
public class KorisnikController {
    ...
    public ListView<ba.unsa.etf.rs.tut5.Korisnik> lista;
    private ba.unsa.etf.rs.tut5.KorisniciModel model;
    ...
    public KorisnikController(ba.unsa.etf.rs.tut5.KorisniciModel m) {
        model = m;
    }
    ...
    public void initialize(){
        ...
        lista.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<ba.unsa.etf.rs.tut5.Korisnik>() {
            @Override
            public void changed(ObservableValue<? extends ba.unsa.etf.rs.tut5.Korisnik> observableValue, ba.unsa.etf.rs.tut5.Korisnik korisnikOld, ba.unsa.etf.rs.tut5.Korisnik korisnikNew) {
                if (korisnikOld != null) {
                    setTextPropetryUnBind();
                }
                if (korisnikNew == null) {
    ...
    private void updateKorisnika() {
        ba.unsa.etf.rs.tut5.Korisnik korisnik = (ba.unsa.etf.rs.tut5.Korisnik) lista.getSelectionModel().getSelectedItem();
        setTextPropetryUnBind();
